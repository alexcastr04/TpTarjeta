...
namespace TpTarjetaTests
{
    ...
    public class ColectivoTests
    {
        ...
        [Test]
        public void ValidarFranquiciaHorario_DiaYHoraValida_RetornaTrue()
        {
            var colectivo = new Colectivo();
            DateTime fecha = new DateTime(2024, 10, 23, 8, 0, 0); // Miércoles, 8:00 AM
    ...
    public class FranquiciaTests
    {
        ...
        public void NoDeberiaPermitirViajeFueraDeFranjaHoraria()
        {
            ...
            Assert.IsFalse(resultado, "Se debería haber bloqueado el viaje fuera del horario permitido.");

            // Prueba fuera de horario (05:59)
            tiempoFalso.AgregarHoras(-16); // Cambia la hora a 05:59
